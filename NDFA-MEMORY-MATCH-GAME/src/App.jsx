...
// Backend: VITE_BACKEND_URL אם הוגדר; אחרת בפרודקשן (לא localhost) → Render; מקומי → :5000
...
function getBackendUrl() {
  ...
  if (import.meta.env.VITE_USE_RENDER_BACKEND === 'true' || import.meta.env.VITE_USE_RENDER_BACKEND === '1') {
    return RENDER_BACKEND
  }
